<template>
  <div>
    <form id="form">
      ...
      />
      <span id="file-span">
        <label id="file-button" for="file" style="padding:5px 5px;">
          <svg
          ...
          >
            <path
              d="M57.8809 0.0880127H454.092C486.029 0.0880127 512 26.1523 512 58.2527V423.822C512 455.885 486.029 481.922 454.092 481.922H57.8826C25.9454 481.922 0.0017395 455.885 0.0017395 423.822V58.2527C2.55797e-05 26.1523 25.9437 0.0880127 57.8809 0.0880127ZM180.915 86.5899C150.03 86.5899 124.983 111.737 124.983 142.741C124.983 173.746 150.032 198.893 180.915 198.893C211.808 198.893 236.847 173.746 236.847 142.741C236.847 111.737 211.808 86.5899 180.915 86.5899ZM76.0416 428.182H256.005H427.951C443.399 428.182 450.278 416.962 443.315 403.12L347.325 212.249C340.37 198.408 327.114 197.172 317.727 209.487L221.206 336.119C211.819 348.436 195.411 349.484 184.552 338.449L160.939 314.444C150.088 303.41 134.101 304.776 125.245 317.476L64.1007 405.159C55.262 417.878 60.594 428.182 76.0416 428.182Z"
              fill="#010002"
            />
          </svg>
        </label>
