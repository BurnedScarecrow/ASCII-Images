        ...
        <div class="wrapper">
          ...
          <section>
            ...
            <p>
              ...
              а ANSI или Unicode символы, можно добиться более точной предачи
              оттенков. ANSI Art появился чуть позже как расширение ASCII. А
              сейчас генераторы текстовых изображений используют как раз
              <a
                href="https://ru.wikipedia.org/wiki/%D0%9F%D1%81%D0%B5%D0%B2%D0%B4%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%BA%D0%B0"
                target="_blank"
                >псевдографику</a
              >
              из Unicode. Так корректируя контрастность исходной картинки можно
              добиться более четкого представления деталей на определенном
              устройстве.
            </p>
          </section>
          <section>
            <h3>Инверсия и прозрачность</h3>
            <p>
              ...
              сменить черный фон на белый и контуры будут более различимыми, но
              позже я автоматизировал процесс преобразования прозрачных черных
              пикселей в белые. В дальнейшем возможно добавлю опцию выбора
              используемого алфавита и надеюсь, жизнь станет проще. Хочется
              верить, что прочтение данной статьи не стало пустой тратой
              времени, и Вы узнали для себя что-то интересное или новое.
            </p>
          </section>
        </div>
      </details>
